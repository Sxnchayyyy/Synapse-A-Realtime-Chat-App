...
const Navbar = () => {
  ...
  return (
    <header className="bg-base-100/90 border-b border-base-300 fixed w-full top-0 z-40 backdrop-blur-lg shadow-sm">
      <div className="container mx-auto px-4 h-16">
        <div className="flex items-center justify-between h-full">
          ...
          <div className="flex items-center gap-2">
            <Link
              to="/settings"
              className="btn btn-sm gap-2 hover:bg-base-300/50 transition-all hover:scale-[1.02]"
            >
